...
model_dict = {
    ...
    'cper_cp': resource_filename('hlsstack', 'models/CPER_HLS_cp_ndvi_2014_2023_20260422.pk'),
    'tbng_biomass': resource_filename('hlsstack', 'models/TB_HLS_to_VOR_biomass_model_pls_20260817.pk'),
